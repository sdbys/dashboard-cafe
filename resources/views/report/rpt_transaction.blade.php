...
<head>
    ...
    <style>
        ...
        /* styling report transaksi */
        #header {position: relative; width: 100%; }
        #header img{width: 100px; position: relative; bottom: 5px; left: 5px}
        #header h2{position: relative; margin: 0; padding: 0; font-size: 25px; font-family: Arial, Helvetica, sans-serif    ;}
        #header p{position: relative; margin: 0; padding: 0; font-size: 16px; font-family: monospace}
        h3 {position:  relative; text-align: center; border-top:2px solid #000; border-bottom:2px solid #000; margin:5px 0; padding: 10px; font-family: Arial, Helvetica, sans-serif; text-transform: uppercase;}

        #dtTrans { position: relative; border: 1px solid #000; width: 100%; border-collapse: collapse; }
        #dtTrans thead { background: rgb(10, 128, 179); }
...
<body>
    <table id="header">
        <tr>
            <td width="5%"><img src="{{ asset('images/sadboi.png')  }}" alt=""></td>
            <td>
                <h2>Cafe Sadboys</h2>
                <p>Jl Mangga No 17 Kota Madiun</p>
            </td>
        </tr>
    </table>
